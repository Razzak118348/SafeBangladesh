...
<section className="py-24 px-4 text-black dark:text-white">
  <div className="">
    ...
    <MotionH2
      ...
      className="text-lg md:text-xl lg:text-2xl mb-16"
    />

    {/* Paragraph */}
    <MotionDiv className="space-y-6 text-center max-w-3xl mx-auto">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-white text-sm">{card.desc}</p>
              </div>
            </div>
          </Tilt>
        </MotionDiv>
