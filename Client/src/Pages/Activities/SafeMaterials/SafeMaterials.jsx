    ...
    <div className="max-w-7xl mx-auto px-4">
      <MotionDiv>
        ...
        <MotionP className="text-gray-700 dark:text-gray-300 text-justify mt-8 leading-relaxed">
          ...
          building materials, we have established <strong>SAFE Materials</strong>.
          This initiative enables residents of the Sundarbon Union to access
          durable construction materials that strengthen homes and extend their
          lifespan.
        </MotionP>
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
          ...
          <li>
            Sand–Cement Tiles (coming soon)
          </li>
        </ul>
        <MotionP className="text-gray-700 dark:text-gray-300 text-justify mb-8 leading-relaxed">
        ...
        {/* image gallery */}
          <MotionDiv className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 my-14 justify-items-center">
        <img
